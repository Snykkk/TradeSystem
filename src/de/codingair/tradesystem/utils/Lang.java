...
public class Lang {
    ...
    public static @Nonnull String getLanguageKey() {
    ...
    private static @Nonnull FileConfiguration getLanguageFile(String langTag) {
    ...
    public static @Nonnull String get(@Nonnull String key, @Nullable Player p) {
