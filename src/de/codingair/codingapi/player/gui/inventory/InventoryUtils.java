...
public class InventoryUtils {
    ...
    public static void updateTitle(@Nonnull Player player, @Nonnull String title, @Nonnull Inventory inventory) {
        if (!isReady()) return;
    ...
    private static Object preparePacket(@Nonnull Object activeContainer, @Nonnull String title, @Nonnull Inventory inventory) {
    ...
    private static Object getTitleComponent(@Nonnull String title) {
